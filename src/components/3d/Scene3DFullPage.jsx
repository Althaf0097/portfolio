...
/**
 * Helper to generate initial particle data outside of component scope
 * to satisfy React 19 purity rules for Math.random().
 */
 ...
 * Optimized with GPU acceleration via ShaderMaterial.
 */
      ...
      <shaderMaterial
        ...
        fragmentShader={`
          ...
          void main() {
            ...
            gl_FragColor = vec4(vColor, 0.7 * strength);
          }
        `}
      />
    </points>
 ...
 * Optimized to read from scrollProgressRef in useFrame.
 */
const FloatingShapes = ({ scrollProgressRef }) => {
  ...
  useFrame((state) => {
    ...
    groupRef.current.position.y = -scrollProgressRef.current * 15.0;
  });
 ...
 * Uses refs for high-frequency updates to maximize performance.
 */
