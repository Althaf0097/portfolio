...
// Helper function defined outside component body to satisfy React 19 purity rules
...
const FloatingParticles = ({ count = 300 }) => {
  ...
  // BOLT OPTIMIZATION: Memoize particles position array and texture generation
  // to avoid garbage collection pressure, HTML Canvas creation, and WebGL texture allocations on renders.
