...
// BOLT OPTIMIZATION: Helper to generate particle positions outside component render to satisfy React 19 purity rules
...
// BOLT OPTIMIZATION: Helper to generate canvas texture once without re-allocating WebGL textures on every render
...
const FloatingParticles = ({ count = 300 }) => {
  ...
  // BOLT OPTIMIZATION: Memoize positions and texture to avoid memory leaks & GC pauses on re-renders
