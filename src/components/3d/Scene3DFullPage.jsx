...
const ParticleField = ({ count = 1000, mousePositionRef, scrollProgressRef }) => {
  ...
  useFrame((state) => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      positions[i3 + 1] = initialPositions[i3 + 1] + floatY + mouseY * 0.3 + scrollProgress * 10;
...
const Scene3DFullPage = () => {
  ...
  // High-frequency values tracked with refs to skip React render cycles (60fps performance)
