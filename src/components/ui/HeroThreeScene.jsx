...
// Helper to generate particle positions outside component/render to maintain purity
...
const CameraController = ({ mouse }) => {
  useFrame(({ camera }) => {
    ...
    // Destructuring camera from state inside useFrame callback to avoid direct React 19 immutability compile errors
