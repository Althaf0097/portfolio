...
// Static color objects for reuse
const ACCENT_COLOR = new THREE.Color('#2563eb'); // blue-600
const BLUE_COLOR = new THREE.Color('#06b6d4'); // cyan-400
const WHITE_COLOR = new THREE.Color('#ffffff');

/**
 * Generates initial particle data in a deterministic-friendly way for React 19
 */
