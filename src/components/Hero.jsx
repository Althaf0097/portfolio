...
const Hero = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      ...
      // BOLT OPTIMIZATION: Use translate3d for GPU-accelerated mouse tracking without re-renders
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20 bg-dark-950">
      ...
      <div 
        ref={glowRef}
        className="absolute w-full h-full z-0 pointer-events-none transition-opacity duration-1000"
        style={{
