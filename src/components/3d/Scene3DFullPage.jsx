...
// Data generation moved outside component for React 19 purity
const generateFullPageParticleData = (count) => {
...
const ParticleField = ({ count = 1000, mousePosition }) => {
  ...
  const particles = useMemo(() => generateFullPageParticleData(count), [count]);
