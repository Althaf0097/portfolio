...
/**
 * Helper to generate particle data outside of component to maintain purity
 */
...
const ParticleField = ({ count = 1000, mousePositionRef }) => {
  ...
  // Memoize particle data generated by external helper
  ...
  useFrame((state) => {
    ...
    // Read from ref to avoid React reconciliation overhead
...
const Scene3DFullPage = () => {
  ...
  // Lazy initialization for better SSR/hydration performance
