...
// BOLT OPTIMIZATION: Performance-optimized 3D Interactive Card
// - Uses cached dimensions via useRef on enter to completely avoid high-frequency .getBoundingClientRect() layout thrashing
// - Animates 3D rotation, position, and glare using GPU-accelerated transforms via gsap.quickTo() helpers
// - Employs hardware-accelerated static background gradient glare translated on the GPU with translate3d
// - Explicitly avoids global transition-all CSS classes to prevent main-thread animation conflicts
const InteractiveCard = ({
  ...
  useEffect(() => {
    ...
    // Initialize GSAP quickTo helpers for smooth hardware-accelerated movement
    quickToRef.current = {
    ...
    // Use percentage offsets to center the glare circle on the cursor
  ...
  const handleMouseMove = (e) => {
    ...
    // Calculate mouse coordinates relative to the card boundaries
    ...
    // Use GSAP quickTo helpers to bypass layout and repaint cost
