...
// BOLT OPTIMIZATION: Moved non-deterministic random position generation to a static helper to comply with React 19 component purity rules
...
const FloatingParticles = ({ count = 300 }) => {
  ...
  // BOLT OPTIMIZATION: Memoize random positions and texture generation to avoid React 19 impurity and memory leaks
...
// BOLT OPTIMIZATION: Destructured camera from the state inside useFrame instead of useThree() hook to satisfy React 19 immutability guidelines
