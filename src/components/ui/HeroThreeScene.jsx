...
// Pure position generator to comply with React 19 purity rules
...
const FloatingParticles = ({ count = 300 }) => {
  ...
  // BOLT OPTIMIZATION: Memoize particle positions & canvas texture to prevent severe GC thrashing
