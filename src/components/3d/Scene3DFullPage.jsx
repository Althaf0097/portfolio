...
/**
 * Helper to generate particle data outside the component to satisfy purity rules
 */
...
const ParticleField = ({ count = 1000, mousePositionRef, scrollProgressRef }) => {
  ...
  useFrame((state) => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      // Add scroll-based vertical offset
      const scrollOffset = scroll * 20;
 ...
 * Optimized for performance by using refs for high-frequency updates
 */
