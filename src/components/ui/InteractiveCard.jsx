...
const InteractiveCard = ({
  ...
  // BOLT OPTIMIZATION: Store GSAP quickTo functions in refs to completely avoid recreation and keep 60fps+ tracking
  ...
  const handleMouseEnter = (e) => {
    ...
    // BOLT OPTIMIZATION: Cache card dimensions on mouse enter to eliminate layout thrashing from getBoundingClientRect during mouse moves
  ...
  const handleMouseMove = (e) => {
    ...
    // BOLT OPTIMIZATION: Calculate page-relative coordinates to keep mouse moves stable across scrolling events
    ...
    // BOLT OPTIMIZATION: Call hardware-accelerated quickTo updates directly
  ...
  return (
    <div
      ...
      // BOLT OPTIMIZATION: Replaced global 'transition-all' with specific non-animated property transitions to avoid GSAP rendering conflicts and animation jitter
    ...
    >
      ...
      {/* BOLT OPTIMIZATION: absolute inset-0 wrapper with overflow-hidden and absolute top-0 left-0 centered glare overlay moved via transform: translate3d() to delegate render to GPU */}
      <div className="absolute inset-0 overflow-hidden z-10 pointer-events-none mix-blend-screen">
        <div
          ref={glareRef}
          className="pointer-events-none absolute top-0 left-0 w-[350px] h-[350px] rounded-full opacity-0"
          style={{
