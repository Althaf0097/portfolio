...
// Helper function for generating static particle positions to ensure component purity
...
const FloatingParticles = ({ count = 300 }) => {
  ...
  // Memoize positions generated from static helper to maintain React 19 purity
  const positions = useMemo(() => generatePositions(count), [count]);

  // Memoize canvas texture to prevent severe memory leaks and GC bottlenecks
