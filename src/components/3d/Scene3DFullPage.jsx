 ...
 */
/**
 * Generates particle data outside the component to satisfy React 19 purity rules
 */
...
const ParticleField = ({ count = 1000, mousePositionRef, scrollProgressRef }) => {
  ...
  useFrame((state) => {
    ...
    const targetY = (scrollProgressRef?.current || 0) * 20;
...
const FloatingShapes = ({ scrollProgressRef }) => {
  ...
  useFrame((state) => {
    ...
    const targetY = (scrollProgressRef?.current || 0) * 25;
