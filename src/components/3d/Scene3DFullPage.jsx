...
// Move particle generation outside to satisfy React 19 purity rules
...
const ParticleField = ({ count = 1000, mousePositionRef, scrollProgressRef }) => {
  ...
  useFrame((state) => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      // Use scroll to affect vertical position
...
const Scene3DFullPage = () => {
  ...
  // Refactor state to refs to prevent re-renders on high-frequency events
