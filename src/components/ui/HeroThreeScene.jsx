...
// BOLT OPTIMIZATION: Memoize particle positions and canvas texture generation in FloatingParticles
// to prevent memory leaks and redundant WebGL texture allocations on every render pass.
